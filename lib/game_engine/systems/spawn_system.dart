...
class SpawnSystem {
  ...
  Vector2 randomPosition({
    ...
    final marginX =
        canvasSize.x * GameConstants.safeAreaMarginFraction + targetRadius;
    ...
    final minSeparation =
        ...
        GameConstants.minSpawnSeparationFraction;
  ...
  bool shouldSpawnGolden() =>
      _random.nextDouble() < GameConstants.goldenDotSpawnChance;
